...
// Zurich Irchel Park
static constexpr const double kDefaultHomeLatitude = 21.154054 * M_PI / 180.0;   // rad   // 47.397742 * M_PI / 180.0
static constexpr const double kDefaultHomeLongitude = -101.703266 * M_PI / 180.0;   // rad   // 8.545594 * M_PI / 180.0
static constexpr const double kDefaultHomeAltitude = 1854.0;                      // meters// 488.0
